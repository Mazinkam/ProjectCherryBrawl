...
GameDPad* GameDPad::dPadWithFile(CCString *fileName, float radius)
{
...
bool GameDPad::initWithFile(CCString *filename, float radius)
{
	bool bRet = false;
	do
	{
...
void GameDPad::onEnterTransitionDidFinish()
{
	CCDirector::sharedDirector()->getTouchDispatcher()->addTargetedDelegate(this, 1, true);
}

void GameDPad::onExit()
{
	CCDirector::sharedDirector()->getTouchDispatcher()->removeDelegate(this);
}

void GameDPad::update(float dt)
{
	if (_isHeld)
	{
...
bool GameDPad::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
...
void GameDPad::ccTouchMoved(CCTouch *pTouch, CCEvent *pEvent)
{
	CCPoint location = pTouch->getLocation();
...
void GameDPad::ccTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
	_direction = CCPointZero;
	_isHeld = false;
	_touchStick->setPosition(ccp(75.0, 75.0));
...
void GameDPad::updateDirectionForTouchLocation(CCPoint location)
{
