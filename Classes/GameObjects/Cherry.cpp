...
//knocked out animation
		...
		this->setAttackBox(this->createBoundingBoxWithOrigin(ccp(this->getCenterToSides(), -10), CCSizeMake(40, 30)));



		this->setCircleAttackBox(this->createBoundingBoxWithOrigin(ccp(-20, -20), CCSizeMake(70, 70)));
